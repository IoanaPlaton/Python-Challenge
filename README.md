...
Adding Instructions from Module 3 Challenge README
...
# References
Used Happy Donut speed runs to reference file creation, list creation, and running through loops.
Used Github references for the calculations of the "profit/losses" data analysis and exporting analysis to text
Used Github references for the vote per person count, percent vote, total vote person loops and list variables.
